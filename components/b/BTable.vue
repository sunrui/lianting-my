  ...
  <div v-show="!ui.loading">
            ...
            <div @click="btnTable(table)">
              ...
              <div class="table_busy" v-else>
                <div class="table_time">
                  <div class="table_one">
                    <img class="table_one_icon" data-src="/img/b/table/b_table_time.png" alt="">
                    <div class="table_one_label">{{getElapsedTime(getTableOrder(table))}}</div>
                  </div>
                </div>
                <div class="table_extra">
                  <div class="table_one">
                    <img class="table_one_icon" data-src="/img/b/table/b_table_people.png" alt="">
                    <div class="table_one_label">{{getTableOrder(table)[0].people}}</div>
                  </div>
                  <div class="table_one">
                    <img class="table_one_icon" data-src="/img/b/table/b_table_order.png" alt="">
                    <div class="table_one_label">{{getTableOrder(table).length}}</div>
                  </div>
                  <div class="table_one">
                    <img class="table_one_icon" data-src="/img/b/table/b_table_food.png" alt="">
                    <div class="table_one_label">{{countFood(getTableOrder(table))}}</div>
                  </div>
                  <div class="table_one">
                    <img class="table_one_icon" data-src="/img/b/table/b_table_wait.png" alt="">
    ...
    <transition name="toggle">
      <div class="modal_bottom" v-if="ui.vMenuTable">
        ...
        <div class="modal_menu" v-if="(roleType === 'retailer' || roleType === 'admin') && getTableOrder(ui.selectTable).length === 0"
             @click="btnTableOrder(ui.selectTable)">订单记录
        </div>
