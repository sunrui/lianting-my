      ...
      box_radius: index !== 0
        ...
        <div class="order_food">
          ...
          <div v-else>
            ...
            <div class="order_food_button order_food_button_cooked" v-if="orderFood.status === 'Cooking'" @click="btnStatus(orderFood, 'Cooked')">做好了</div>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      btnStatus(orderFood, status) {
        ...
        let content = `确认将<span style="color:#f52626; font-weight: 400">"${orderFood.foodCategoryName}"</span>` +
