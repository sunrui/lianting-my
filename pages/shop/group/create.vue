  ...
  <div>
    ...
    <div class="box">
      <div class="addition box_radius">
        ...
        <div class="addition_item">
          <div class="addition_item_label">公司</div>
          <input class="addition_item_input" placeholder="请输入公司" minlength="2" maxlength="20"
                 v-model="http.req.shopGroup.corporation">
        </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      httpCreate() {
        httpShopGroupApi.post(this.http.req.shopGroup).then(res => {
          if (res.haveFree) {
            this.$msgBox.doModal({
              type: 'yes',
              title: '创建品牌',
      ...
      btnCreate() {
        if (!Boolean(this.http.req.shopGroup.name)) {
          this.$msgBox.doModal({
            type: 'yes',
            title: '创建品牌',
            content: '请输入品牌名称。'
        ...
        if (!Boolean(this.http.req.shopGroup.corporation)) {
          this.$msgBox.doModal({
            type: 'yes',
            title: '创建品牌',
            content: '请输入公司名称。'
        ...
        if (this.http.req.shopGroup.corporation.length < 2) {
          this.$msgBox.doModal({
            type: 'yes',
            title: '创建品牌',
            content: '公司名称最少两位。'
