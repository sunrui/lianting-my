      ...
      <div class="shop_center">
        <div class="shop_info">
          ...
          <div class="shop_menu">
            ...
            <img class="shop_menu_icon" data-src="/img/b/menu/b_menu_shop_open.png" v-if="http.res.shop.open" @click="btnShopOpen" alt="">
            <img class="shop_menu_icon" data-src="/img/b/menu/b_menu_shop_close.png" v-else @click="btnShopOpen" alt="">
